...
brogan_cards := []Card_Data {
    Card_Data { name = "Onslaught",
        color =         .GOLD,
        initiative =    11,
        values =        #partial{.DEFENSE = 3, .ATTACK = 4, .MOVEMENT = 1},
        primary =       .ATTACK,
    ...
    Card_Data { name = "Mad Dash",
        ...
        tier =          1,
        initiative =    7,
        values =        #partial{.DEFENSE = 7, .ATTACK = 6, .MOVEMENT = 3},
        primary =       .ATTACK,
    ...
    Card_Data { name = "Brutal Jab",
        ...
        tier =          1,
        initiative =    8,
        values =        #partial{.DEFENSE = 5, .MOVEMENT = 2},
        primary =       .SKILL,
    ...
    Card_Data { name = "Bullrush",
        ...
        tier =          2,
        initiative =    7,
        values =        #partial{.DEFENSE = 8, .ATTACK = 6, .MOVEMENT = 3},
        primary =       .ATTACK,
        item =          .ATTACK,
    ...
    Card_Data { name = "Throwing Axe",
        ...
        alternate =     true,
        initiative =    7,
        values =        #partial{.DEFENSE = 7, .ATTACK = 3, .MOVEMENT = 4},
        primary =       .ATTACK,
        reach =         Range(2),
        item =          .DEFENSE,
    ...
    Card_Data { name = "Mighty Punch",
        ...
        tier =          2,
        initiative =    9,
        values =        #partial{.DEFENSE = 6, .MOVEMENT = 2},
        primary =       .SKILL,
        item =          .INITIATIVE,
    ...
    Card_Data { name = "Furious Charge",
        ...
        tier =          3,
        initiative =    8,
        values =        #partial{.DEFENSE = 8, .ATTACK = 7, .MOVEMENT = 3},
        primary =       .ATTACK,
        item =          .MOVEMENT,
    ...
    Card_Data { name = "Throwing Spear",
        ...
        alternate =     true,
        initiative =    8,
        values =        #partial{.DEFENSE = 7, .ATTACK = 4, .MOVEMENT = 4},
        primary =       .ATTACK,
        reach =         Range(2),
        item =          .RADIUS,
