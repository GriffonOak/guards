...
test_basic_upgrade :: proc(t: ^testing.T) {
    ...
    event_log := []Event {
        ...
        Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Green, tier = 1, alternate = false}, state = .In_Hand}},
        ...
        Space_Hovered_Event{space = {0, 0}},
        Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Blue, tier = 1, alternate = false}, state = .In_Hand}},
        ...
        Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Gold, tier = 0, alternate = false}, state = .In_Hand}},
        ...
        Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Silver, tier = 0, alternate = false}, state = .In_Hand}},
        ...
        Space_Hovered_Event{space = {0, 0}},
        Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Blue, tier = 2, alternate = true}, state = .In_Deck}},
    }
...
test_xargatha_freeze :: proc(t: ^testing.T) {
    ...
    event_log := []Event {
        ...
        End_Resolution_Event{player_id = 1},
        Resolve_Current_Action_Event{jump_index = Action_Index{sequence = Action_Sequence_ID.Halt, card_id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Silver, tier = 0, alternate = false}, index = 0}},
        Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Red, tier = 1, alternate = false}, state = .In_Hand}},
...
test_xargatha_charm :: proc(t: ^testing.T) {
    ...
    event_log1 := []Event {
        ...
        Begin_Game_Event{},
        Space_Hovered_Event{space = {0, 0}},
        Card_Clicked_Event{card = Card{id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Blue, tier = 1, alternate = false}, state = .In_Hand}},
        Card_Confirmed_Event{player_id = 0, maybe_card_id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Blue, tier = 1, alternate = false}},
        ...
        Space_Clicked_Event{space = {6, 16}},
        Space_Hovered_Event{space = {0, 0}},
        Card_Clicked_Event{card = Card{id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Red, tier = 1, alternate = false}, state = .In_Hand}},
        Card_Confirmed_Event{player_id = 0, maybe_card_id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Red, tier = 1, alternate = false}},
        ...
        Space_Hovered_Event{space = {0, 0}},
        Resolve_Current_Action_Event{jump_index = nil},
        Card_Clicked_Event{card = Card{id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Green, tier = 1, alternate = false}, state = .In_Hand}},
        Card_Confirmed_Event{player_id = 0, maybe_card_id = Card_ID{hero_id = Hero_ID.Xargatha, owner_id = 0, color = Card_Color.Green, tier = 1, alternate = false}},
        Space_Hovered_Event{space = {0, 0}},
...
@(test)
test_xarg_charm_alt_order :: proc(t: ^testing.T) {
    gs: Game_State
    setup_board(&gs)
...
//         Begin_Game_Event{},
//         Space_Hovered_Event{space = {0, 0}},
//         Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Dodger, owner_id = 0, color = Card_Color.Green, tier = 1, alternate = false}, state = .In_Hand}},
...
//         Space_Clicked_Event{space = {7, 9}},
//         Space_Hovered_Event{space = {0, 0}},
//         Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Dodger, owner_id = 0, color = Card_Color.Blue, tier = 1, alternate = false}, state = .In_Hand}},
...
//         Space_Hovered_Event{space = {0, 0}},
//         Resolve_Current_Action_Event{jump_index = nil},
//         Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Dodger, owner_id = 0, color = Card_Color.Gold, tier = 0, alternate = false}, state = .In_Hand}},
...
//         Space_Hovered_Event{space = {0, 0}},
//         Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Dodger, owner_id = 0, color = Card_Color.Silver, tier = 0, alternate = false}, state = .In_Hand}},
//         Marker_Event{},
...
//         Space_Hovered_Event{space = {0, 0}},
//         Marker_Event{},
//         Card_Clicked_Event{card = {id = Card_ID{hero_id = Hero_ID.Dodger, owner_id = 0, color = Card_Color.Red, tier = 1, alternate = false}, state = .In_Hand}},
//     }
...
test_swap :: proc(t: ^testing.T) {
    ...
    event_log1 := []Event {
        ...
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Tigerclaw, color = Card_Color.Green, tier = 1, alternate = false}, state = .In_Hand}},
        ...
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Tigerclaw, color = Card_Color.Silver, tier = 0, alternate = false}, state = .In_Hand}},
        ...
        Space_Hovered_Event{space = {12, 0}},
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Tigerclaw, color = Card_Color.Blue, tier = 1, alternate = false}, state = .In_Hand}},
        Space_Hovered_Event{space = {19, 0}},
        ...
        Minion_Removal_Event{targets = {{11, 9}, {}, {}, {}, {}, {}}, num_targets = 1, removing_player = 1},
        End_Resolution_Event{player_id = 1},
        ...
        Space_Hovered_Event{space = {19, 0}},
        Resolve_Current_Action_Event{jump_index = nil},
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Tigerclaw, color = Card_Color.Red, tier = 1, alternate = false}, state = .In_Hand}},
        ...
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Tigerclaw, color = Card_Color.Red, tier = 1, alternate = false}, state = .In_Hand}},
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Tigerclaw, color = Card_Color.Red, tier = 2, alternate = false}, state = .In_Hand}},
        Space_Hovered_Event{space = {20, 4}},
...
test_invalid_double_upgrade :: proc(t: ^testing.T) {
    event_log := []Event {
        ...
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Brogan, color = Card_Color.Green, tier = 1, alternate = false}, state = .In_Hand}},
        ...
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Brogan, color = Card_Color.Blue, tier = 1, alternate = false}, state = .In_Hand}},
        ...
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Brogan, color = Card_Color.Gold, tier = 0, alternate = false}, state = .In_Hand}},
        ...
        Minion_Removal_Event{targets = {{11, 9}, {}, {}, {}, {}, {}}, num_targets = 1, removing_player = 1},
        End_Resolution_Event{player_id = 1},
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Brogan, color = Card_Color.Red, tier = 1, alternate = false}, state = .In_Hand}},
        ...
        Resolve_Current_Action_Event{jump_index = nil},
        End_Resolution_Event{player_id = 1},
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Brogan, color = Card_Color.Blue, tier = 2, alternate = false}, state = .In_Deck}},
    }
    ...
    event_log2 := []Event {
        Card_Clicked_Event{card = {id = Card_ID{owner_id = 0, hero_id = Hero_ID.Brogan, color = Card_Color.Green, tier = 2, alternate = false}, state = .In_Deck}},
    }
